...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({ id: agent.id, name: agent.name, email: agent.email, commissionRate: agent.commissionRate, allowedPaymentMethods: agent.allowedPaymentMethods });
}