...
export default function BookingForm({ onSearch, agentInfo, onHireBus }: BookingFormProps) {
  ...
  const defaultRoutes: Route[] = [
    ...
    // Corridor: northbound day (Gaborone → Maun bus)
    { id: 'default-7', name: 'Gaborone to Kang', origin: 'Gaborone', destination: 'Kang', active: true },
    { id: 'default-8', name: 'Gaborone to Ghanzi', origin: 'Gaborone', destination: 'Ghanzi', active: true },
    { id: 'default-9', name: "Gaborone to D'Kar", origin: 'Gaborone', destination: "D'Kar", active: true },
    { id: 'default-10', name: 'Gaborone to Sandfire', origin: 'Gaborone', destination: 'Sandfire', active: true },
    { id: 'default-11', name: 'Gaborone to Sehithwa', origin: 'Gaborone', destination: 'Sehithwa', active: true },
    { id: 'default-12', name: 'Gaborone to Toteng', origin: 'Gaborone', destination: 'Toteng', active: true },
    { id: 'default-13', name: 'Kumakwane to Maun', origin: 'Kumakwane', destination: 'Maun', active: true },
    { id: 'default-14', name: 'Thamaga to Maun', origin: 'Thamaga', destination: 'Maun', active: true },
    { id: 'default-15', name: 'Moshupa to Maun', origin: 'Moshupa', destination: 'Maun', active: true },
    { id: 'default-16', name: 'Kanye to Maun', origin: 'Kanye', destination: 'Maun', active: true },
    { id: 'default-17', name: 'Jwaneng to Maun', origin: 'Jwaneng', destination: 'Maun', active: true },
    { id: 'default-18', name: 'Kang to Maun', origin: 'Kang', destination: 'Maun', active: true },
    { id: 'default-19', name: 'Ghanzi to Maun', origin: 'Ghanzi', destination: 'Maun', active: true },
    { id: 'default-20', name: 'Kanye to Toteng', origin: 'Kanye', destination: 'Toteng', active: true },
    { id: 'default-21', name: 'Jwaneng to Toteng', origin: 'Jwaneng', destination: 'Toteng', active: true },
    // Corridor: southbound day (Maun → Gaborone bus)
    { id: 'default-22', name: 'Maun to Ghanzi', origin: 'Maun', destination: 'Ghanzi', active: true },
    { id: 'default-23', name: 'Maun to Kang', origin: 'Maun', destination: 'Kang', active: true },
    { id: 'default-24', name: 'Maun to Jwaneng', origin: 'Maun', destination: 'Jwaneng', active: true },
    { id: 'default-25', name: 'Maun to Kanye', origin: 'Maun', destination: 'Kanye', active: true },
    { id: 'default-26', name: 'Maun to Moshupa', origin: 'Maun', destination: 'Moshupa', active: true },
    { id: 'default-27', name: 'Maun to Thamaga', origin: 'Maun', destination: 'Thamaga', active: true },
    { id: 'default-28', name: 'Maun to Kumakwane', origin: 'Maun', destination: 'Kumakwane', active: true },
    { id: 'default-29', name: 'Toteng to Gaborone', origin: 'Toteng', destination: 'Gaborone', active: true },
    { id: 'default-30', name: 'Sehithwa to Gaborone', origin: 'Sehithwa', destination: 'Gaborone', active: true },
    { id: 'default-31', name: 'Sandfire to Gaborone', origin: 'Sandfire', destination: 'Gaborone', active: true },
    { id: 'default-32', name: "D'Kar to Gaborone", origin: "D'Kar", destination: 'Gaborone', active: true },
    { id: 'default-33', name: 'Ghanzi to Gaborone', origin: 'Ghanzi', destination: 'Gaborone', active: true },
    { id: 'default-34', name: 'Kang to Gaborone', origin: 'Kang', destination: 'Gaborone', active: true },
    { id: 'default-35', name: 'Toteng to Jwaneng', origin: 'Toteng', destination: 'Jwaneng', active: true },
    { id: 'default-36', name: 'Toteng to Kanye', origin: 'Toteng', destination: 'Kanye', active: true },
  ];
